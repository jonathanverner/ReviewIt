...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('commentbin_snippet', 'language', self.gf('django.db.models.fields.CharField')(default='py', max_length=4), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Snippet.language'
        db.delete_column('commentbin_snippet', 'language')
